...
calf_gg_richness_timepoints_sex_no_overlap_no_bg <- calf_gg_richness_timepoints_sex_no_overlap +
  theme(
    panel.background = element_blank(),
    plot.background = element_rect(fill = "transparent", color = NA), # Required for transparency
    legend.background = element_rect(fill = "transparent", color = NA),
...
# Save with the bg parameter
ggsave(
  filename = "alpha_diversity_curve/calf_gg_richness_timepoints_sex_no_overlap_no_bg_trans.png",
  plot = calf_gg_richness_timepoints_sex_no_overlap_no_bg,
  height = 4, 
  width = 6,
  bg = "transparent"  # This is the key argument for ggsave
)
